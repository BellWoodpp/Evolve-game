import { global, save, webWorker, p_on, isMainTabActive } from './vars.js';
...
import { buildGarrison, checkControlling, defineGovernment, govTitle } from './civics.js';
...
const techs = {
    ...
    mining: {
        id: 'tech-mining',
        class(){ return global.race['sappy'] ? 'sap-hardening-action' : ''; },
    ...
    government: {
        ...
        post(){
            if (!$('#government').length && $('#r_civics').length){
                defineGovernment();
            }
            if ($('#government').length){
                ...
                if (global.settings.tabLoad || isMainTabActive('civic') || global.settings.civicEmbedded){
    ...
    science: {
        id: 'tech-science',
        class: 'scientific-method-action',
    ...
    library: {
        id: 'tech-library',
        class: 'dewey-decimal-system-action',
