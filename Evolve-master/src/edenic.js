import { global, p_on, sizeApproximation, seededRandom, isMainTabActive } from './vars.js';
...
export function renderEdenic(){
    if (!global.settings.tabLoad && (!isMainTabActive('civ') || global.settings.spaceTabs !== 7)){
        return;
    }
    let parent = $('#eden');
    clearElement(parent);
